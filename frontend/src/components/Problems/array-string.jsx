...
export default function ArrayString() {
  const questions = [
    { id: 1, title: 'Merge Sorted Array', difficulty: 'Easy', acceptance: '60%' },
    { id: 2, title: 'Remove Element', difficulty: 'Easy', acceptance: '50%' },
    { id: 3, title: 'Remove Duplicates from Sorted Array', difficulty: 'Medium', acceptance: '45%' },
    { id: 4, title: 'Remove Duplicates from Sorted Array II', difficulty: 'Hard', acceptance: '35%' },
  ];
